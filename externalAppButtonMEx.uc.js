...
*/ 
	...
	init : function () {
		...
		ExternalAppBtn.style.listStyleImage = "url(data:image/png;base64,)";
	...
	function updateToolbar() {
		...
		Array.slice(toolbars).forEach(function (toolbar) {
			...
			if (currentset.split(",").indexOf("ExternalAppbtnMEx") < 0)
				return;
